...
var _user$project$Main$hasAnyProduct = function (model) {
	var _p0 = model.productNames;
	if (_p0.ctor === 'Success') {
		return A2(
			_elm_lang$core$List$any,
			function (_p1) {
...
var _user$project$Main$getEntryTypeName = function (entry) {
	return A2(_elm_lang$core$String$contains, '[ERROR]', entry.type_) ? 'error' : (A2(_elm_lang$core$String$contains, '[WARNING]', entry.type_) ? 'warning' : 'info');
};
var _user$project$Main$viewEntries = function (model) {
	var _p2 = model.logEntries;
	switch (_p2.ctor) {
		case 'NotAsked':
			return {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Please select a product.'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			};
		case 'Loading':
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('loadingLabel'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
		...
		default:
			var _p3 = _p2._0;
			if (_p3.ctor === '[]') {
				var _p4 = model.productName;
				if (_p4.ctor === 'Just') {
					return {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Log contains no entries..'),
						_1: {ctor: '[]'}
					};
				} else {
					return _user$project$Main$hasAnyProduct(model) ? {
						ctor: '::',
						_0: _elm_lang$html$Html$text('No product selected'),
						_1: {ctor: '[]'}
					} : {
						ctor: '::',
						_0: _elm_lang$html$Html$text(''),
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$pre,
									{
										...
										_0: _elm_lang$html$Html_Attributes$class(
											_user$project$Main$getEntryTypeName(e)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('entryDate'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(e.date),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
												...
												_0: _elm_lang$html$Html$text(
													A2(
														...
														A2(
															...
															A2(_elm_lang$core$Basics_ops['++'], '] ', e.message)))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$addEntriesToLog = F2(
	function (oldData, newEntries) {
		var _p5 = oldData;
		if (_p5.ctor === 'Success') {
			return A2(
				_krisajenkins$remotedata$RemoteData$map,
				function (oldEntries) {
					return A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], oldEntries, newEntries));
				},
				oldData);
		} else {
...
var _user$project$Main$addNewEntries = F2(
	function (model, unparsedMessages) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				logEntries: A2(_user$project$Main$addEntriesToLog, model.logEntries, unparsedMessages)
			});
	});
var _user$project$Main$logFunction = function (str) {
	return A2(_elm_lang$core$Debug$log, '', str);
};
var _user$project$Main$getService = F2(
	function (bag, serviceKey) {
		return A2(_elm_lang$core$Dict$get, serviceKey, bag);
	});
var _user$project$Main$registerService = F3(
	function (serviceKey, service, bag) {
		return A3(
			_elm_lang$core$Dict$update,
			serviceKey,
			function (old) {
				return _elm_lang$core$Maybe$Just(service);
			},
			bag);
	});
var _user$project$Main$emptyServiceManager = _elm_lang$core$Dict$empty;
var _user$project$Main$LogEntry = F4(
	function (a, b, c, d) {
		return {id: a, type_: b, date: c, message: d};
	});
var _user$project$Main$logEntryDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Main$LogEntry,
	...
	A2(_elm_lang$core$Json_Decode$field, 'message', _elm_lang$core$Json_Decode$string));
var _user$project$Main$parseLogEntry = function (str) {
	var decoderResult = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$logEntryDecoder, str);
	var _p6 = decoderResult;
	if (_p6.ctor === 'Ok') {
		return _elm_lang$core$Maybe$Just(_p6._0);
	} else {
		var _p7 = A2(_elm_lang$core$Debug$log, _p6._0, 'Foo? ');
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Main$parseEntries = function (stringMessages) {
	return A2(
		_elm_lang$core$List$filterMap,
		_elm_lang$core$Basics$identity,
		A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Main$parseLogEntry, stringMessages)));
};
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {logEntries: a, productName: b, productNames: c, history: d};
	});
var _user$project$Main$Logger = function (a) {
	return {ctor: 'Logger', _0: a};
};
var _user$project$Main$Test = function (a) {
	return {ctor: 'Test', _0: a};
};
var _user$project$Main$testService = function (foo) {
	var serviceManager = A3(
		_user$project$Main$registerService,
		'Test',
		_user$project$Main$Test('Something'),
		A3(
			_user$project$Main$registerService,
			'Log',
			_user$project$Main$Logger(_user$project$Main$logFunction),
			_user$project$Main$emptyServiceManager));
	var _p9 = A2(_user$project$Main$getService, serviceManager, 'Log');
	if ((_p9.ctor === 'Just') && (_p9._0.ctor === 'Logger')) {
		return _p9._0._0('Steve!');
	} else {
		return 'Guess we have no logger';
	}
};
var _user$project$Main$ProductPage = function (a) {
	return {ctor: 'ProductPage', _0: a};
};
...
var _user$project$Main$route = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Main$ProductPage,
				A2(
					_evancz$url_parser$UrlParser_ops['<?>'],
					_evancz$url_parser$UrlParser$s('page'),
					_evancz$url_parser$UrlParser$stringParam('product'))),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$handleLocationChange = F2(
	function (model, location) {
		var _p10 = A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Main$route, location);
		if (_p10.ctor === 'Just') {
			var _p13 = _p10._0;
			var modelWithHistory = _elm_lang$core$Native_Utils.update(
				model,
				{
					history: {
						ctor: '::',
			...
			var _p11 = _p13;
			if (_p11.ctor === 'ProductPage') {
				if (_p11._0.ctor === 'Just') {
					var _p12 = _p11._0._0;
					var subCmd = A2(
						_elm_lang$websocket$WebSocket$send,
						'ws://127.0.0.1:8080/ws',
						A2(_elm_lang$core$Basics_ops['++'], 'subscribe|', _p12));
					var newModel = _elm_lang$core$Native_Utils.update(
						modelWithHistory,
						{
							productName: _elm_lang$core$Maybe$Just(_p12),
							logEntries: _krisajenkins$remotedata$RemoteData$Loading
						});
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							modelWithHistory,
							{productName: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			} else {
				return {ctor: '_Tuple2', _0: modelWithHistory, _1: _elm_lang$core$Platform_Cmd$none};
			}
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Main$LogEntriesReceived = function (a) {
	return {ctor: 'LogEntriesReceived', _0: a};
};
var _user$project$Main$LoadOlder = {ctor: 'LoadOlder'};
var _user$project$Main$LogsReceived = function (a) {
	return {ctor: 'LogsReceived', _0: a};
};
var _user$project$Main$getHistoryCmd = function (productName) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Main$LogsReceived,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(
				_elm_lang$http$Http$get,
				A2(_elm_lang$core$Basics_ops['++'], '/logs/', productName),
				_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string))));
};
...
var _user$project$Main$update = F2(
	function (message, model) {
		...
		switch (_p14.ctor) {
			...
			case 'LoadOlder':
				var lowestIdOrZero = function () {
					var _p15 = model.logEntries;
				...
				var loadCmd = function () {
					var _p17 = model.productName;
					if (_p17.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$Main$LogEntriesReceived,
							_krisajenkins$remotedata$RemoteData$sendRequest(
								A2(
									_elm_lang$http$Http$get,
									A2(
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(
														A2(_elm_lang$core$Basics$max, 0, lowestIdOrZero - 20)),
													'&limit=20')))),
									_elm_lang$core$Json_Decode$list(_user$project$Main$logEntryDecoder))));
					} else {
						return _elm_lang$core$Platform_Cmd$none;
					}
				}();
				return {ctor: '_Tuple2', _0: model, _1: loadCmd};
			case 'LogEntriesReceived':
				var _p18 = _p14._0;
				if (_p18.ctor === 'Success') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Main$addNewEntries, model, _p18._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'UrlChanged':
				return A2(_user$project$Main$handleLocationChange, model, _p14._0);
			case 'NewMessage':
				var _p19 = A2(
				...
				if (_p19.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Main$addNewEntries, model, _p19._0),
						_1: A2(
							_elm_lang$core$Task$attempt,
							_elm_lang$core$Basics$always(_user$project$Main$NoOp),
							_elm_lang$dom$Dom_Scroll$toBottom('history'))
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'UpdateProductNames':
				var _p21 = _p14._0;
				var activateSingleProductCmd = function () {
					var _p20 = _p21;
					if (((_p20.ctor === 'Success') && (_p20._0.ctor === '::')) && (_p20._0._1.ctor === '[]')) {
						return _elm_lang$navigation$Navigation$newUrl(
							A2(_elm_lang$core$Basics_ops['++'], '/page/?product=', _p20._0._0));
					} else {
						return _elm_lang$core$Platform_Cmd$none;
					}
				}();
				...
				var entries = A2(
					...
					function (strEntries) {
						return A2(
							...
							_user$project$Main$parseEntries(strEntries));
					},
					_p14._0);
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$UpdateProductNames = function (a) {
	return {ctor: 'UpdateProductNames', _0: a};
};
var _user$project$Main$init = function (location) {
	var emptyModel = {
		logEntries: _krisajenkins$remotedata$RemoteData$NotAsked,
		productName: _elm_lang$core$Maybe$Nothing,
		productNames: _krisajenkins$remotedata$RemoteData$Loading,
		history: {
			ctor: '::',
	...
	var _p22 = A2(_user$project$Main$handleLocationChange, emptyModel, location);
	var modelWithRoute = _p22._0;
	var routeCmd = _p22._1;
	var getProductNamesCmd = A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Main$UpdateProductNames,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(
				_elm_lang$http$Http$get,
				'/products',
...
var _user$project$Main$viewProductNames = function (model) {
	var isActiveProduct = function (productName) {
		var _p23 = model.productName;
		if (_p23.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(productName, _p23._0);
		}
	};
	var productClassName = function (productName) {
		var _p24 = isActiveProduct(productName);
		if (_p24 === true) {
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Main$NewUrl(
										A2(_elm_lang$core$Basics_ops['++'], '/page/?product=', pn))),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Main$view = function (model) {
	var showLoadOlder = function () {
		var _p26 = model.logEntries;
		if (_p26.ctor === 'Success') {
			return !A2(
				_elm_lang$core$List$any,
				function (e) {
					return _elm_lang$core$Native_Utils.eq(e.id, 0);
				},
				_p26._0);
		} else {
			return false;
	...
	var loadOlderLink = showLoadOlder ? A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('loadOlder'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LoadOlder),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Load older'),
			_1: {ctor: '[]'}
		}) : _elm_lang$html$Html$text('');
	var entries = _user$project$Main$viewEntries(model);
	var productNames = _user$project$Main$viewProductNames(model);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'padding', _1: '3px 0'},
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$UrlChanged = function (a) {
...
var _user$project$Main$main = A2(
	...
	_user$project$Main$UrlChanged,
	{
		init: _user$project$Main$init,
		view: _user$project$Main$view,
		update: _user$project$Main$update,
		subscriptions: function (_p27) {
			return A2(_elm_lang$websocket$WebSocket$listen, 'ws://127.0.0.1:8080/ws', _user$project$Main$NewMessage);
		}
	})();
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{"Main.LogEntry":{"type":"{ id : Int, type_ : String, date : String, message : String }","args":[]},"Navigation.Location":{"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }","args":[]},"RemoteData.WebData":{"type":"RemoteData.RemoteData Http.Error a","args":["a"]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]}},"unions":{"Main.Msg":{"tags":{"NewUrl":["String"],"LogsReceived":["RemoteData.WebData (List String)"],"LoadOlder":[],"NoOp":[],"UpdateProductNames":["RemoteData.WebData (List String)"],"UrlChanged":["Navigation.Location"],"NewMessage":["String"],"LogEntriesReceived":["RemoteData.WebData (List Main.LogEntry)"]},"args":[]},"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]},"RemoteData.RemoteData":{"tags":{"Failure":["e"],"NotAsked":[],"Success":["a"],"Loading":[]},"args":["e","a"]}}},"versions":{"elm":"0.18.0"}});
}
